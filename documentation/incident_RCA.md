...
The issue was caused by incorrect field mapping during the Salesforce import process.
...
**Expected Result:** Contact associated with the correct Account.

**Actual Result:** Contact associated with the correct Account.
